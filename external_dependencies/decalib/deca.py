...
class DECA(nn.Module):
    ...
    def decode(self, codedict, rendering=True, iddict=None, vis_lmk=True, return_vis=True, use_detail=True):
        ...
        if return_vis:
            ...
            if self.cfg.model.use_tex:
                ...
                visdict['rendered_detail_images'] = predicted_detail_images
    ...
    def save_obj(self, filename, opdict, use_texture: bool = True, use_detail: bool = True):
        '''
